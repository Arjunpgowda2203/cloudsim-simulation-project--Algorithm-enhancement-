...
public class CloudSimOneHostManyDatacenters {
    ...
    public static void main(String[] args) {
        ...
        Log.printLine("Starting CloudSim with One Host and Many Datacenters...");
        ...
        try {
            ...
            Log.printLine("Finished CloudSim with One Host and Many Datacenters!");
        } catch (Exception e) {
            e.printStackTrace();
