...
public class CloudSimOneDatacenterManyHosts {
    ...
    public static void main(String[] args) {
        ...
        Log.printLine("Starting CloudSim with One Datacenter and Many Hosts...");
        ...
        try {
            ...
            Log.printLine("Finished CloudSim with One Datacenter and Many Hosts!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static Datacenter createDatacenter(String name) {
        ...
        for (int i = 0; i < 3; i++) {  // Create 3 hosts
            hostList.add(
                new Host(
                    i,
